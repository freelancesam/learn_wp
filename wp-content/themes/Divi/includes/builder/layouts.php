...
<<<<<<< HEAD
define( 'ET_BUILDER_PREDEFINED_LAYOUTS_VERSION', 6 );
=======
...
<<<<<<< HEAD
			if ( isset( $et_builder_layout['applicability'] ) ) {
				$meta['_et_pb_layout_applicability'] = $et_builder_layout['applicability'];
			} else {
				unset( $meta['_et_pb_layout_applicability'] );
			}
