<?php
add_action('widgets_init', 'tn_register_module8_widget');

function tn_register_module8_widget()
{
    register_widget('tn_module8_widget');
}

class tn_module8_widget extends WP_Widget
{

    function tn_module8_widget()
    {
        $widget_ops = array('classname' => 'module8-widget', 'description' => __('[Content Widget] This widget can place in PRIMARY CONTENT or FULL WIDTH. please, Enable 3 Columns layout if you place it into FULL WIDTH','tn'));
        $this->WP_Widget('module8-widget', __('TN . POSTS BOX 8', 'tn'), $widget_ops);
    }
    ...
    function widget($args, $instance)
    {
        ...
        if ($title == 'default') {
            ...
            } else $title = esc_attr__('POSTS BOX 8','tn');
        }
        ...
        if ($query_data) :?>
            <div id="<?php echo $id; ?>">
                <?php  echo tn_module8($query_data->posts ,$options); ?>
            </div><!-- #row -->
        <?php endif;
    ...
    {
        $defaults = array('title' => 'default', 'sort_order' => 'date_post', 'pagination' => 'next_prev', 'posts_per_page' => 6, 'cate' => '', 'child_cate' => '', 'num_child_cate' => '', 'cates' => '', 'tags' => '','readmore' =>'' ,'excerpt' =>18 ,'col_3'=>'');
