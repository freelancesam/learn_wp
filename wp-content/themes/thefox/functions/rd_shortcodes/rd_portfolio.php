...
//Set thumbnail depending on portfolio design					 
	...
	if ( $port_type == "port_type_10" ) {
		echo '<div class="port_item_details"><a href="' .  $linkToTheWork  . '"><h2>' . get_the_title() . '</h2></a></div>';
	}
			   ...
			   /*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!CONFIG!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
                ...
                function get_portfolio_works (this_obj) {
                    ...
                    $.ajax({
                        ...
                        data: "html_template="+html_template+"&now_open_works="+now_open_works+"&action=get_portfolio_works"+"&works_per_load="+works_per_load+"&order="+order+"&orderby="+orderby+"&thumbnail="+thumbnail+"&tags=<?php echo esc_js($tags); ?>&category=<?php echo esc_js($category); ?>",
