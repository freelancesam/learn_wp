        ...
        <?php if ('Leave Empty' != Avada()->settings->get('header_left_content') || 'Leave Empty' != Avada()->settings->get('header_right_content')) : ?>
            ...
            <div class="fusion-secondary-header">
                <div class="fusion-row">
                    <?php if ($content_1) : ?>
                        <div class="fusion-alignleft"><?php echo $content_1; ?></div><div class="header-text" style="text-align: center;">Nirvana Health Products - Australian Manufacturers & Producers</div>
                    <?php endif; ?>
                    <?php if ($content_2) : ?>
...
if (!function_exists('avada_header_1')) {
    ...
    function avada_header_1() {
        ...
        <div class="tvfusion-headertop">
            <div class="fusion-row">
                <?php tvavada_logo();
                ?>

                <nav id="tv-navigation" class="tv-navigation" role="navigation" aria-label="<?php esc_attr_e('Primary Menu', 'twentysixteen'); ?>">
                    <?php
                    wp_nav_menu(array(
                        'theme_location' => 'header-menu',
                        'menu_class' => 'hreader-menu'
                    ));
                    ?>
                </nav><!-- .main-navigation -->
        ...
        <div class="fusion-header tvfusion-headerbottom">
            <div class="fusion-row">
                <?php avada_logo(); ?>
                <?php avada_main_menu(); ?>
            </div>
...
/*
 * Changed by: Tran Trong Thang(trantrongthang1207@gmail.com)
 */
if (!function_exists('tvavada_logo')) {

    function tvavada_logo() {
        /**
         * No need to proceed any further if no logo is set
         */
        if ('' == Avada()->settings->get('logo') && '' == Avada()->settings->get('logo_retina')) {
        ...
        <div class="tvfusion-logo" data-margin-top="<?php echo intval(Avada()->settings->get('margin_logo_top')); ?>px" data-margin-bottom="<?php echo intval(Avada()->settings->get('margin_logo_bottom')); ?>px" data-margin-left="<?php echo intval(Avada()->settings->get('margin_logo_left')); ?>px" data-margin-right="<?php echo intval(Avada()->settings->get('margin_logo_right')); ?>px">
            <?php
            /**
             * avada_logo_prepend hook
             */
