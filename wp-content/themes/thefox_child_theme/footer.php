            ...
            <div class="wrapper">
                <div id="footer">
                    <div class="widget_wrap">
                        <?php
                        if (is_active_sidebar('thefox_fs_col1')) {
                    ...
                    <?php if ($footer_col == 'footer_4_col' || $footer_col == 'footer_3_col' || $footer_col == 'footer_2_col') { ?>
                        <div class="widget_wrap">
                            <?php
                            if (is_active_sidebar('thefox_fs_col2')) {
                    ...
                    <?php } if ($footer_col == 'footer_4_col' || $footer_col == 'footer_3_col') { ?>
                        <div class="widget_wrap">
                            <?php
                            if (is_active_sidebar('thefox_fs_col3')) {
                    ...
                    <?php } if ($footer_col == 'footer_4_col') { ?>
                        <div class="widget_wrap">
                            <?php
                            if (is_active_sidebar('thefox_fs_col4')) {
...
<div class="menu_slide mt_menu sticky_header" >
    <div class="wrapper tf_o_visible">
        ...
        <?php if ($rd_data['rd_logo']['url'] !== '' && $rd_data['rd_mobile_logo']['url'] !== '') { ?>
            <div id="logo_img"><a href="<?php echo home_url(''); ?>"><img class="dark_logo mobile_logo" src="<?php
                    if ($rd_data['rd_logo_color'] == 'light_logo_selected') {
                        echo esc_url($rd_data['rd_mobile_white_logo']['url']);
                    } else {
                        echo esc_url($rd_data['rd_mobile_logo']['url']);
                    }
        ...
        <?php } elseif ($rd_data['rd_logo']['url'] !== '') { ?>
            <div id="logo_img"><a href="<?php echo home_url(''); ?>"><img class="dark_logo mobile_logo" src="<?php
                    if ($rd_data['rd_logo_color'] == 'light_logo_selected') {
                        echo esc_url($rd_data['rd_white_logo']['url']);
                    } else {
                        echo esc_url($rd_data['rd_logo']['url']);
                    }
                    ?>" alt="<?php bloginfo('name'); ?>" title="<?php bloginfo('name'); ?>"/></a></div>
...
<script>
    jQuery(document).ready(function ($) {
        ...
        jQuery('#represent_section ul.tabs li').click(function () {
            var tab_id = jQuery(this).attr('data-tab');

            jQuery('#represent_section ul.tabs li').removeClass('current');
            jQuery('#represent_section .tab-content').removeClass('current');

            jQuery(this).addClass('current');
            jQuery("#" + tab_id).addClass('current');
        })
        $('#upper_second li.tab-link').append('<span class="triangle"><span class="inner-triangle"></span></span>');
    })
    jQuery(document).ready(function () {

        jQuery('#upper_second ul.tabs li').click(function () {
            var tab_id = jQuery(this).attr('data-tab');

            jQuery('#upper_second ul.tabs li').removeClass('current');
            jQuery('#upper_second .tab-content').removeClass('current');
            jQuery(this).addClass('current');
            jQuery("#" + tab_id).addClass('current');
        })
