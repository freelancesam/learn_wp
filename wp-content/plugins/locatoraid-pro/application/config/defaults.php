...
$config['address_format'] = <<<EOT
{STREET}
{CITY} {STATE} {ZIP}
{COUNTRY}
EOT;
$config['perpage'] = 12;
$config['use_text_labels'] = 0;
$config['mapsapi'] = '';
$config['require_street'] = 1;
