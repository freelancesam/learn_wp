...
<?php if( ! (isset($GLOBALS['NTS_NOT_ADMIN']) && $GLOBALS['NTS_NOT_ADMIN']) ) : ?>
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo lang('menu_conf'); ?><b class="caret"></b></a>
					<ul class="dropdown-menu">  
						<li>
							<a href="<?php echo ci_site_url( array('admin', 'conf', 'mapsapi') ); ?>">Google Maps API Key</a>
						</li>
						<li>
					...
					<?php endif; ?>
						...
						<li>
							<a href="<?php echo ci_site_url( array('admin', 'conf', 'address') ); ?>"><?php echo lang('menu_conf_address');?></a>
						</li>
					</ul>
				</li>
