...
class Utils
{
    public static function fillSkyline(&$projections, Skyline $skyline, $insertCallback)
    {
        while ($projections && !$skyline->isFull()) {
            ...
            if (isset($bestItemIndex)) {
                ...
                call_user_func($insertCallback, $bestItemIndex, $itemProjection);
            } else {
    ...
    private static function findBestFitItem($projections, Skyline $skyline)
    {
        $bestItemIndex = null;
        ...
        foreach ($projections as $idx => $list) {
            ...
            foreach ($list as $projection) {
                ...
                if ($fitness > $bestFitnessValue) {
                    ...
                    if ($bestFitnessValue == Skyline::MAX_FITNESS_VALUE) {
                        break;
                    }
                }
            }
