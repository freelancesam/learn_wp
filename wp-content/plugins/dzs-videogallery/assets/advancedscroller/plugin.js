...
//                    console.info(toload);
            ...
            function calculate_dims(pargs){
                ...
                // console.info("ITEMS PER PAGE ", items_per_page, cw, _thumbsClip.children().eq(0).outerWidth(true));
                ...
                if(String(design_itemwidth).indexOf("%")>-1){
                    ...
                    // _thumbsClip.children().css('width', parseFloat(cw/4));
                }
