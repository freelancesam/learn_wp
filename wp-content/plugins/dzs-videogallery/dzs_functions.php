...
//                print_r($matches);
        ...
        static function add_query_arg()
        {
            ...
            DZSHelpers::wp_parse_str($query, $qs);
            $qs = DZSHelpers::urlencode_deep($qs); // this re-URL-encodes things that were already in the query string
            if (is_array($args[0])) {
                $kayvees = $args[0];
