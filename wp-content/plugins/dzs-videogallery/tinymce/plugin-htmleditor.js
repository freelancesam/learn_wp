...
jQuery(document).ready(function($){
    ...
    $('#dzsvg_shortcode').bind('click', function(){
        ...
        window.dzszb_open(dzsvg_settings.shortcode_generator_url, 'iframe', {bigwidth: 1200, bigheight: 700,forcenodeeplink: 'on', dims_scaling: 'fill'});
    })
    $('#dzsvg_shortcode_addvideoshowcase').bind('click', function(){
        ...
        window.dzszb_open(dzsvg_settings.shortcode_showcase_generator_url+parsel, 'iframe', {bigwidth: 1200, bigheight: 700,forcenodeeplink: 'on', dims_scaling: 'fill'});
    });
