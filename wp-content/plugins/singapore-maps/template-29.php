<?php
/*
 * Template for "Singapore Maps" Wordpress plugin 
 */
...
if (!empty($settings['mapsize']) && $settings['mapsize'] != '100') {
    ...
    if ($mapsize > 0) {
        ...
        $style = sprintf("height: %dpx; width: %dpx;", $height, ($width + 205));
    }
}
...
<div id='singapore_maps'>
    ...
    <div id='maps_container'<?php echo $style; ?><?php echo $class; ?>>
        <div id='north_map' class='google_map'>North</div>
        <div id='northeast_map' class='google_map'>North-East</div>
        <div id='east_map' class='google_map'>East</div>
        <div id='west_map' class='google_map'>West</div>
        <div id='central_map' class='google_map'>Central</div>
        <?php
