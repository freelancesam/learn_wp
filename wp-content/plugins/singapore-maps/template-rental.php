<?php
/*
 * Template for "Singapore Maps" - Rental Post Type Wordpress plugin 
 */
...
$listings = sm_get_rental_listings();
...
<div id='singapore_maps' class="singapore_maps_rental">
    ...
    <div id='maps_container'<?php echo $style; ?><?php echo $class; ?>>
        <div id='rental_north_map' class='google_map'>North</div>
        <div id='rental_northeast_map' class='google_map'>North-East</div>
        <div id='rental_east_map' class='google_map'>East</div>
        <div id='rental_west_map' class='google_map'>West</div>
        <div id='rental_central_map' class='google_map'>Central</div>
        <?php
